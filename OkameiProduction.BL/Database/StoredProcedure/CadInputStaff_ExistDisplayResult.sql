IF EXISTS (select * from sys.objects where name = 'CadInputStaff_ExistDisplayResult')
BEGIN
    DROP PROCEDURE [CadInputStaff_ExistDisplayResult] 
END
GO 
Create PROCEDURE [dbo].[CadInputStaff_ExistDisplayResult]
