...
BEGIN
    ...
    SELECT 
        ...
        ,CASE WHEN buk.KakousijishoHakkouDate   IS NOT NULL THEN 'â¡çHéwé¶çœÇ›'
                WHEN buk.KakoutuShouninDate     IS NOT NULL THEN 'â¡çHè≥îFçœÇ›'
                WHEN buk.FusezuTeishutuDate     IS NOT NULL THEN 'å©êœíÒèoçœÇ›'
