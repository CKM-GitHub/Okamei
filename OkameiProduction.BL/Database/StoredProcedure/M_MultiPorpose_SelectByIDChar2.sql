IF EXISTS (select * from sys.objects where name = 'M_MultiPorpose_SelectByIDChar2')
BEGIN
    DROP PROCEDURE [M_MultiPorpose_SelectByIDChar2]
END
GO

CREATE PROCEDURE [dbo].[M_MultiPorpose_SelectByIDChar2](
    @ID  int
    ,@Char2 varchar(100)
)AS
BEGIN
