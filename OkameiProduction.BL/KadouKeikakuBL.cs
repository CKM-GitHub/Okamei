...
namespace OkameiProduction.BL
{
    public class KadouKeikakuBL
    {
        public bool ExistsDisplayResult(KadouKeikakuModel model)
        {
            ...
            sqlParams[7] = new SqlParameter("@OukazaiSumi", SqlDbType.VarChar) { Value = model.OukazaiSumi.ToInt16(0) };
            sqlParams[8] = new SqlParameter("@HasirazaiSumi", SqlDbType.VarChar) { Value = model.HasirazaiSumi.ToInt16(0) };
            sqlParams[9] = new SqlParameter("@HagarazaiSumi", SqlDbType.VarChar) { Value = model.HagarazaiSumi.ToInt16(0) };
            sqlParams[10] = new SqlParameter("@YukaSumi", SqlDbType.VarChar) { Value = model.YukaSumi.ToInt16(0) };
            sqlParams[11] = new SqlParameter("@NoziSumi", SqlDbType.VarChar) { Value = model.NoziSumi.ToInt16(0) };
            sqlParams[12] = new SqlParameter("@KabeSumi", SqlDbType.VarChar) { Value = model.KabeSumi.ToInt16(0) };
            sqlParams[13] = new SqlParameter("@HiuchiSumi", SqlDbType.VarChar) { Value = model.HiuchiSumi.ToInt16(0) };
            sqlParams[14] = new SqlParameter("@TekakouSumi", SqlDbType.VarChar) { Value = model.TekakouSumi.ToInt16(0) };
            sqlParams[15] = new SqlParameter("@HundeggerSumi", SqlDbType.VarChar) { Value = model.HundeggerSumi.ToInt16(0) };
            sqlParams[16] = new SqlParameter("@UserID", SqlDbType.VarChar) { Value = model.UserID.ToStringOrNull() };
